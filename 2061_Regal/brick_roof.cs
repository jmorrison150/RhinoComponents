...
/// </summary>
public class brick_roof : GH_ScriptInstance
{
    ...
    /// </summary>
    private void RunScript(Surface surface, bool uv, ref object cuttingPlanes)
    {
        ...
        for (int i = 0; i < ts.Length; i++)
        {
            ...
            Curve c3 = c1.OffsetNormalToSurface(surface, -distance);
