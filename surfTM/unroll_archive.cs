...
namespace gsd {
    public class unroll : Grasshopper.Kernel.GH_Component {
        ...
        protected override void RegisterInputParams(Grasshopper.Kernel.GH_Component.GH_InputParamManager pManager) {
            pManager.AddGeometryParameter("surfaces", "surfaces", "brep or surface to unroll", Grasshopper.Kernel.GH_ParamAccess.list);
        ...
        protected override void RegisterOutputParams(Grasshopper.Kernel.GH_Component.GH_OutputParamManager pManager) {
            pManager.Register_BRepParam("surfaces", "surfaces", "unrolled surfaces");
            pManager.Register_CurveParam("curves", "curves", "unrolled curves");
            pManager.Register_PointParam("points", "points", "unrolled points");
            pManager.Register_CurveParam("text", "text", "index of each piece as text curves");
        ...
        protected override void SolveInstance(Grasshopper.Kernel.IGH_DataAccess DA) {
            ...
            for (int i = 0; i < geometryInput.Count; i++) {
                Surface surface;
                Brep brep;
                if (geometryInput[i].CastTo<Surface>(out surface)) {
                    inputSurfaces.Add(surface);
                } else if (geometryInput[i].CastTo<Brep>(out brep)) {
                    inputBreps.Add(brep);
                }
            }
