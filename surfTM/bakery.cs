...
namespace gsd {
    public class Bakery : Grasshopper.Kernel.GH_Component {
        public Bakery() : base(".bakery", ".bakery", "an EZ bake oven", "Extra", "Util") { }
        public override Guid ComponentGuid {
            get { return new Guid("{6E14F9DC-38B1-4D17-BE91-E87D708D51D9}"); }
        }
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager) {
            ...
            pManager.AddTextParameter("sliders", "sliders", "finds sliders. each slider needs a unique name", GH_ParamAccess.list);
            pManager.AddTextParameter("layers", "layers", "finds layers in Rhino", GH_ParamAccess.list);
        ...
        protected override void SolveInstance(Grasshopper.Kernel.IGH_DataAccess DA) {
            ...
            DA.GetData<bool>(3, ref activate);
                ...
                DA.GetDataList<string>(1, sliders);
                if (!DA.GetDataList<string>(2, layers)) { layers.Add(doc.Layers.CurrentLayer.Name); }
            ...
            //}
                ...
                if (!activate) { bakeCount = 0; bakeDistance = 0.0; }

                bakeCount++;
                bakeDistance = translateX;
                #endregion
