...
/// </summary>
public class Script_Instance12 : GH_ScriptInstance {
    ...
    /// </summary>
    private void RunScript(List<Polyline> curves, double offsetTop, double offsetBottom, 
        double varyTop, double varyBottom, 
