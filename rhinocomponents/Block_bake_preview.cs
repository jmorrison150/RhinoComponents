...
/// </summary>
public class Script_Instance20 : GH_ScriptInstance {
  ...
  private void RunScript(bool bake, List<GeometryBase> G, Point3d L, Color C) {
    ...
    if (bake) {
      Rhino.DocObjects.InstanceDefinition I = Rhino.RhinoDoc.ActiveDoc.InstanceDefinitions.Find(NAME, false);

      if (I != null)
        Rhino.RhinoDoc.ActiveDoc.InstanceDefinitions.Delete(I.Index, true, true);

      int index = Rhino.RhinoDoc.ActiveDoc.InstanceDefinitions.Add(NAME, "description", Point3d.Origin, G);
      Rhino.RhinoDoc.ActiveDoc.Objects.AddInstanceObject(index, Transform.Scale(L, 1));
    }
    #endregion
  ...
  public override void DrawViewportWires(IGH_PreviewArgs args) {
    ...
    args.Display.DrawPoint(LOCATION, Rhino.Display.PointStyle.ActivePoint, 3, Color.Gray);
