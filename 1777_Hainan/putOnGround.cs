...
public class Script_Instance : GH_ScriptInstance
{
    ...
    /// </summary>
    private void RunScript(Curve curves, Surface ground, ref object A)
    {

        Point3d pt;
        AreaMassProperties areaMass = AreaMassProperties.Compute(curves);
        pt = areaMass.Centroid;
        ...
        if (pt2[0].IsPoint)
        {
            ...
            Transform xForm = Transform.Translation(pt2[0].PointA - pt);
            curves.Transform(xForm);
        }
        A = curves;
    }
