...
/// </summary>
public class Script_Instance33 : GH_ScriptInstance {
    ...
    /// </summary>
    private void RunScript(List<double> graph, List<Plane> planes, 
      List<Curve> curves, List<Brep> breps, double maxDist, 
      double offsetDist, bool reset, ref object A, ref object B) {
